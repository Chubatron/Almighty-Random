...
class IntermediateRandom(MainMenuScreen):
    ...
    def create_buttons(self, layout):
        ...
        sports = [
            ('Random', 'assets/images/buttons/Dice_button.png', 'random', self.change_to_game),
            ('RandomNumber', 'assets/images/buttons/Dice_button.png', 'random_number', self.change_to_game),
        ]
